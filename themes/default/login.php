							...
							<fieldset>
								<div class="form-group">
									<div class="form-group input-group">
										...
										<input class="form-control input-lg" title="<?php echo Language::translate("LBL_LOGIN"); ?>" placeholder="<?php echo Language::translate("LBL_LOGIN"); ?>" name="email" type="email" autofocus required>
									</div>
								</div>
								<div class="form-group input-group">
									<span class="input-group-addon cp-login-span">
									...
									<input class="form-control input-lg" title="<?php echo Language::translate("LBL_LOGIN"); ?>" placeholder="<?php echo Language::translate("LBL_PASSWORD"); ?>" name="pass" type="password" value="" required>
								</div>
